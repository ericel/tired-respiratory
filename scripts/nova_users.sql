...
--
-- Table structure for table `weydey_users`
--

CREATE TABLE `weydey_users` (
...
--
-- Dumping data for table `weydey_users`
--

INSERT INTO `weydey_users` (`id`, `role_id`, `username`, `password`, `realname`, `email`, `active`, `image`, `activation_code`, `remember_token`, `created_at`, `updated_at`) VALUES
...
--
-- Indexes for table `weydey_users`
--
ALTER TABLE `weydey_users`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `weydey_users`
--
ALTER TABLE `weydey_users`
