...
--
-- Table structure for table `weydey_roles`
--

CREATE TABLE `weydey_roles` (
...
--
-- Dumping data for table `weydey_roles`
--

INSERT INTO `weydey_roles` (`id`, `name`, `slug`, `description`, `created_at`, `updated_at`) VALUES
...
--
-- Indexes for table `weydey_roles`
--
ALTER TABLE `weydey_roles`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `weydey_roles`
--
ALTER TABLE `weydey_roles`
